        ...
        >
            ...
            <div className={styles.block}>
                ...
                <MoreTextCheckbox
                    text={
                        <>
                        In addition, I have read the information about the country chosen on the
                        website of the Ministry of Foreign Affairs in the section
                        &nbsp;&quot;Advice for travelers&quot;. I will check this information a few days
                        before my departure. The signatory commits all the participants making up
                        the group.
                        </>
                    }
                    />
                    ...
                    text={
                        <>
                        In addition, I have familiarized myself with{" "}
                        <a href="#" style={{ color: "var(--blue)" }}>
                            Nomads Voyage&apos;s Responsible Tourism Policy
                        </a>
                        , which outlines best practices for minimizing environmental and social
                        impacts while traveling through Central Asia. I pledge to uphold these
